...
function TopRated() {
    ...
    async function getData() {
      const response = await axios.get('https://api.themoviedb.org/3/movie/top_rated?api_key=daffd40bac50d42bcf8b01b32b4e9b9b&language=en-US&page=1')
    ...
    const cards = topRatedMovies.map(movie => {
